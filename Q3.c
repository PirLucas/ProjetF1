...
int main(int argc, char* argv[]){
	...
	if ((strcmp(argv[1], "normal") == 0)){ //normalement impossible pour Q3, mais on garde au cas ou
		...
		nbr = creeVoitures(shCoureurs, clas, "rapportQ2.txt");
		memcpy(copy, shCoureurs, sizeof(struct voiture)*nbr);
	}
	...
	affichageTxt(tri(copy, shCoureurs,sizeof(struct voiture), nbr), nbr, clas, "rapportQ3.txt");
