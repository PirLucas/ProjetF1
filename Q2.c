...
int main(int argc, char* argv[]){
	...
	int duree = 4; //changer pour la durée d'un Q2
	int pid;
	...
	if ((strcmp(argv[1], "normal") == 0)){ //normalement impossible pour Q2, mais on garde au cas ou
		...
		nbr = creeVoitures(shCoureurs, clas, "rapportQ1.txt");
		memcpy(copy, shCoureurs, sizeof(struct voiture)*nbr);
	}
	...
	affichageTxt(tri(copy, shCoureurs,sizeof(struct voiture), nbr), nbr, clas, "rapportQ2.txt");
