...
int main(int argc, char* argv[]){
	...
	int duree = 4; //changer pour la durée d'un P3
	int pid;
	...
	if ((strcmp(argv[1], "normal") == 0)){
		...
		nbr = creeVoitures(shCoureurs, clas, "rapportP2.txt");
		memcpy(copy, shCoureurs, sizeof(struct voiture)*nbr);
	}
	...
	affichageTxt(tri(copy, shCoureurs,sizeof(struct voiture), nbr), nbr, clas, "rapportP3.txt");
